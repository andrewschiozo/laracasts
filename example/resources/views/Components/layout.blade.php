    ...
    <body class="h-full">
        ...
        <nav class="bg-gray-800">
            ...
            <div class="flex h-16 items-center justify-between">
                ...
                <div class="hidden md:block">
                    ...
                    <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
                        <x-menu-link href="/" class="rounded-md bg-gray-900 px-3 py-2 text-sm font-medium text-white" aria-current="page">Home</x-menu-link>
                        <x-menu-link href="/about" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">About</x-menu-link>
                        <x-menu-link href="/contact" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Contact</x-menu-link>
                    </div>
                </div>
                </div>
                <div class="hidden md:block">
            ...
            <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
                <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
                <x-menu-link href="/" class="block rounded-md bg-gray-900 px-3 py-2 text-sm font-medium text-white" aria-current="page">Home</x-menu-link>
                <x-menu-link href="/about" class="block rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">About</x-menu-link>
                <x-menu-link href="/contact" class="block rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Contact</x-menu-link>
            </div>
        ...
        <header class="bg-white shadow-sm">
            ...
            <h1 class="text-3xl font-bold tracking-tight text-gray-900">{{ $pageHeadingTitle }}</h1>
            </div>
        </header>
        <main>
            <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
